...
\mezera 
\citace{Firmy si začali uvědomovat výhody, které z~open source softwaru plynou, a stále častěji se přímým způsobem podílejí na jeho vývoji.}\citepages{129}{Fogel2012}
\mezera
...
Finanční riziko zase představuje neušetření financí (alespoň na začátku) při migraci na open source. Důvodem může být využití investičních nákladů na mzdách pracovníků, kteří budou nový systém upravovat a nastavovat. 
