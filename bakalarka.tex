...
\thesissetup{
    ...
    date			  = 2016/03/12,
    keywords	  	  = {open source, Koha, Aleph, knihovní system, migrace},
	TeXkeywords	  = {open source, Koha, Aleph, knihovní system, migrace},
	%keywords	En    = {open source, Koha, Aleph, library system, migration}, % throws error
...
%\makeatletter\thesis@load
%  \makeatletter\def\thesis@blocks@lobibliography{%
